...
@Transactional
public interface SqlPipeBatchRepository extends JpaRepository<SqlPipeBatch,Integer> {
     ...
     *@Date: 10:39 2018/4/7
     **/
    List<SqlPipeBatch> findByIsDelete(Boolean isDelete);
     ...
     *@Date: 10:40 2018/4/7
     **/
    List<SqlPipeBatch> findByIsUpdate(Boolean isUpdate);
