...
public class PipeSurface {
    ...
    public PipeSurface(int oldId,int midId, Boolean isDelete, Boolean isUpdate, String surfaceCode, String surfaceFullName, String surfaceShortName) {
        this.oldId = oldId;
